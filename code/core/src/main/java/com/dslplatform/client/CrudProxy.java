...
public interface CrudProxy {
	 ...
	 */
	public <T extends Identifiable> Future<T> read(Class<T> manifest, String uri);
	 ...
	 */
	public <TAggregate extends AggregateRoot> Future<TAggregate> create(TAggregate aggregate);
	 ...
	 */
	public <TAggregate extends AggregateRoot> Future<TAggregate> update(TAggregate aggregate);
	 ...
	 */
	public <TAggregate extends AggregateRoot> Future<TAggregate> delete(Class<TAggregate> manifest, String uri);
}
